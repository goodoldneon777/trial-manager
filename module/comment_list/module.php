<?php
	...
	function create_comment_list($type, $pageType, $seq = null) {
	    ...
	    while($row = $result->fetch_assoc()) {
	      ...
	      if ($type === 'readonly') {
	      	...
	      	$html .= "  		<a href=\"javascript: void(0)\" onclick=\"m_commentList.deleteComment('" . $commentClass . "')\" class=\"delete\">Delete</a>";
	      	$html .= "    </div> \n";
	      	$html .= "  </td> \n";
	      }
	    	$html .= "</tr> \n";
