<?php
	...
	function create_option($inputName, $value, $writeType) {
		...
		//<<< Get input info.
		$sql = "
			select html_type, title, title_short, tooltip, tooltip_enable_flag
			from param_input
		...
		if ($html_type === 'select') {	//Generate dropdown html.
			$sql = "
				select d.name_id, d.title, d.title_short, d.tooltip, d.tooltip_enable_flag, o.order_num, o.option_value, o.option_text
				from param_input d
