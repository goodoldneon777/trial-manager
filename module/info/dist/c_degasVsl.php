<?php
	...
	function create_degasVsl($pageType, $seq = null) {
		...
		$sql = "
			select distinct p.`name`, p.`order`, p.`value`, p.`text`, t.degas_vsl,
				case when p.`text` = t.degas_vsl then 'selected' else '' end as `selected`
