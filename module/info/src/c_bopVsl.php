<?php
	...
	function create_bopVsl($pageType, $seq = null) {
		...
		$sql = "
			select distinct p.`name`, p.`order`, p.`value`, p.`text`, t.bop_vsl,
				case when p.`text` = t.bop_vsl then 'selected' else '' end as `selected`
