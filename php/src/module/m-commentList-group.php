<?php
	...
	function create_commentList_trial($type, $groupSeq = null) {
	    ...
	    while($row = $result->fetch_assoc()) {
	      ...
	      if ($type === 'readonly') {
	      	...
	      	$html .= "  		<a href=\"javascript: void(0)\" onclick=\"m_commentList_trial.deleteComment('" . $commentClass . "')\" class=\"delete\">Delete</a>";
	      	$html .= "    </div> \n";
	      	$html .= "  </td> \n";
	      }
	    	$html .= "</tr> \n";
...
<div class="container noPad-xs">
	...
	<div class="m-commentList-trial panel panel-primary">
...
<script src="js/dist/m-commentList-trial.min.js"></script>
