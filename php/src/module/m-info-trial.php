<?php
	...
	function create_info_trial($type, $trialSeq = null) {
		...
		if ($trialSeq !== null) {
			...
			$sql = "
				select 
					trial_name, start_dt, end_dt, proc_chg_num, twi_num, owner,
...
<div class="container noPad-xs">
	...
	<div class="m-info-trial panel panel-primary">
...
<script src="js/dist/m-info-trial.min.js"></script>
